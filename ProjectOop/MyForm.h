...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(25, 233);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(150, 57);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Реєстрація";
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(181, 233);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(150, 58);
			...
			this->ClientSize = System::Drawing::Size(363, 321);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		authorization^ auth = gcnew authorization();
		auth->Text = "Авторизація";
		auth->ShowDialog();
	}
	};
}
